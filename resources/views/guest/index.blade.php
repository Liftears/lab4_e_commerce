...
<div class="container mt-1">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex justify-content-center">
            <form action="{{ route('guest.index') }}" method="GET" class="d-flex">
    ...
    <div class="row">
        @foreach($products as $product)
            <div class="col-md-3 mb-4">
                <a href="{{ route('guest.show', $product->id) }}" class="card-link">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="card-text text-justify">
                                ...
                                <span style="font-size: 1rem; font-weight: bold;">
                                    @if($product->discount > 0)
                                        <span class="d-none d-lg-inline" style="text-decoration: line-through;">
                                            ₱{{ number_format($product->origprice, 2, '.', ',') }}</span>
                                        <span class="d-none d-lg-inline" style="text-decoration: none;">&nbsp;</span>
